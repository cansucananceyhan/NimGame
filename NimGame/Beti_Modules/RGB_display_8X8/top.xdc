...
# Switches 
set_property PACKAGE_PIN V17 [get_ports {newGame}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {newGame}] 
set_property PACKAGE_PIN V16 [get_ports {irp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {irp}] 
set_property PACKAGE_PIN W16 [get_ports {ilp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {ilp}] 
set_property PACKAGE_PIN W17 [get_ports {drp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {drp}] 
set_property PACKAGE_PIN W15 [get_ports {dlp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {dlp}] 
